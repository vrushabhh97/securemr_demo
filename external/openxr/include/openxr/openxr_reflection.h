...
#define XR_LIST_STRUCT_XrRenderModelAssetNodePropertiesEXT(_) _(uniqueName)
...
#define XR_LIST_STRUCTURE_TYPES_CORE(_) \
  ...
  _(XrInteractionRenderModelTopLevelUserPathGetInfoEXT,                                                                \
...
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_EXT_spatial_anchor(_) _(CreateSpatialAnchorEXT, EXT_spatial_anchor)
