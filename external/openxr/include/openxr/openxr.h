...
typedef XrResult(XRAPI_PTR* PFN_xrStructureTypeToString2KHR)(XrInstance instance, XrStructureType value,
                                                             char buffer[XR_MAX_STRUCTURE_NAME_SIZE_EXTENDED_KHR]);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrStructureTypeToString2KHR(XrInstance instance, XrStructureType value,
                                                           char buffer[XR_MAX_STRUCTURE_NAME_SIZE_EXTENDED_KHR]);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateRenderModelEXT)(XrSession session, const XrRenderModelCreateInfoEXT* createInfo,
                                                        XrRenderModelEXT* renderModel);
typedef XrResult(XRAPI_PTR* PFN_xrDestroyRenderModelEXT)(XrRenderModelEXT renderModel);
typedef XrResult(XRAPI_PTR* PFN_xrGetRenderModelPropertiesEXT)(XrRenderModelEXT renderModel,
                                                               const XrRenderModelPropertiesGetInfoEXT* getInfo,
                                                               XrRenderModelPropertiesEXT* properties);
typedef XrResult(XRAPI_PTR* PFN_xrCreateRenderModelSpaceEXT)(XrSession session,
                                                             const XrRenderModelSpaceCreateInfoEXT* createInfo,
                                                             XrSpace* space);
typedef XrResult(XRAPI_PTR* PFN_xrCreateRenderModelAssetEXT)(XrSession session,
...
typedef XrResult(XRAPI_PTR* PFN_xrGetRenderModelAssetDataEXT)(XrRenderModelAssetEXT asset,
...
typedef XrResult(XRAPI_PTR* PFN_xrGetRenderModelStateEXT)(XrRenderModelEXT renderModel,
                                                          const XrRenderModelStateGetInfoEXT* getInfo,
                                                          XrRenderModelStateEXT* state);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrCreateRenderModelEXT(XrSession session, const XrRenderModelCreateInfoEXT* createInfo,
                                                      XrRenderModelEXT* renderModel);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroyRenderModelEXT(XrRenderModelEXT renderModel);

XRAPI_ATTR XrResult XRAPI_CALL xrGetRenderModelPropertiesEXT(XrRenderModelEXT renderModel,
                                                             const XrRenderModelPropertiesGetInfoEXT* getInfo,
                                                             XrRenderModelPropertiesEXT* properties);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateRenderModelSpaceEXT(XrSession session,
                                                           const XrRenderModelSpaceCreateInfoEXT* createInfo,
                                                           XrSpace* space);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateRenderModelAssetEXT(XrSession session,
                                                           const XrRenderModelAssetCreateInfoEXT* createInfo,
                                                           XrRenderModelAssetEXT* asset);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroyRenderModelAssetEXT(XrRenderModelAssetEXT asset);

XRAPI_ATTR XrResult XRAPI_CALL xrGetRenderModelAssetDataEXT(XrRenderModelAssetEXT asset,
                                                            const XrRenderModelAssetDataGetInfoEXT* getInfo,
                                                            XrRenderModelAssetDataEXT* buffer);

XRAPI_ATTR XrResult XRAPI_CALL xrGetRenderModelAssetPropertiesEXT(XrRenderModelAssetEXT asset,
                                                                  const XrRenderModelAssetPropertiesGetInfoEXT* getInfo,
                                                                  XrRenderModelAssetPropertiesEXT* properties);

XRAPI_ATTR XrResult XRAPI_CALL xrGetRenderModelStateEXT(XrRenderModelEXT renderModel,
                                                        const XrRenderModelStateGetInfoEXT* getInfo,
                                                        XrRenderModelStateEXT* state);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
typedef XrResult(XRAPI_PTR* PFN_xrEnumerateInteractionRenderModelIdsEXT)(
    XrSession session, const XrInteractionRenderModelIdsEnumerateInfoEXT* getInfo, uint32_t renderModelIdCapacityInput,
    uint32_t* renderModelIdCountOutput, XrRenderModelIdEXT* renderModelIds);
typedef XrResult(XRAPI_PTR* PFN_xrEnumerateRenderModelSubactionPathsEXT)(
    XrRenderModelEXT renderModel, const XrInteractionRenderModelSubactionPathInfoEXT* info, uint32_t pathCapacityInput,
    uint32_t* pathCountOutput, XrPath* paths);
typedef XrResult(XRAPI_PTR* PFN_xrGetRenderModelPoseTopLevelUserPathEXT)(
...
typedef XrResult(XRAPI_PTR* PFN_xrEnumerateSpatialEntityComponentTypesBD)(
    XrSenseDataSnapshotBD snapshot, XrSpatialEntityIdBD entityId, uint32_t componentTypeCapacityInput,
    uint32_t* componentTypeCountOutput, XrSpatialEntityComponentTypeBD* componentTypes);
typedef XrResult(XRAPI_PTR* PFN_xrGetSpatialEntityUuidBD)(XrSenseDataSnapshotBD snapshot, XrSpatialEntityIdBD entityId,
                                                          XrUuidEXT* uuid);
typedef XrResult(XRAPI_PTR* PFN_xrGetSpatialEntityComponentDataBD)(
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSenseDataProviderBD)(XrSession session,
...
typedef XrResult(XRAPI_PTR* PFN_xrStartSenseDataProviderAsyncBD)(XrSenseDataProviderBD provider,
                                                                 ...
                                                                 XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrStartSenseDataProviderCompleteBD)(XrSession session, XrFutureEXT future,
                                                                    XrFutureCompletionEXT* completion);
typedef XrResult(XRAPI_PTR* PFN_xrGetSenseDataProviderStateBD)(XrSenseDataProviderBD provider,
                                                               XrSenseDataProviderStateBD* state);
typedef XrResult(XRAPI_PTR* PFN_xrQuerySenseDataAsyncBD)(XrSenseDataProviderBD provider,
                                                         const XrSenseDataQueryInfoBD* queryInfo, XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrQuerySenseDataCompleteBD)(XrSenseDataProviderBD provider, XrFutureEXT future,
...
typedef XrResult(XRAPI_PTR* PFN_xrGetQueriedSenseDataBD)(XrSenseDataSnapshotBD snapshot,
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialEntityAnchorBD)(XrSenseDataProviderBD provider,
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateAnchorSpaceBD)(XrSession session, const XrAnchorSpaceCreateInfoBD* createInfo,
                                                       XrSpace* space);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrEnumerateSpatialEntityComponentTypesBD(XrSenseDataSnapshotBD snapshot,
                                                                        XrSpatialEntityIdBD entityId,
                                                                        uint32_t componentTypeCapacityInput,
                                                                        uint32_t* componentTypeCountOutput,
                                                                        XrSpatialEntityComponentTypeBD* componentTypes);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSpatialEntityUuidBD(XrSenseDataSnapshotBD snapshot, XrSpatialEntityIdBD entityId,
                                                        XrUuidEXT* uuid);

XRAPI_ATTR XrResult XRAPI_CALL
xrGetSpatialEntityComponentDataBD(XrSenseDataSnapshotBD snapshot, const XrSpatialEntityComponentGetInfoBD* getInfo,
                                  XrSpatialEntityComponentDataBaseHeaderBD* componentData);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSenseDataProviderBD(XrSession session,
                                                           const XrSenseDataProviderCreateInfoBD* createInfo,
                                                           XrSenseDataProviderBD* provider);

XRAPI_ATTR XrResult XRAPI_CALL xrStartSenseDataProviderAsyncBD(XrSenseDataProviderBD provider,
                                                               const XrSenseDataProviderStartInfoBD* startInfo,
                                                               XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrStartSenseDataProviderCompleteBD(XrSession session, XrFutureEXT future,
                                                                  XrFutureCompletionEXT* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSenseDataProviderStateBD(XrSenseDataProviderBD provider,
                                                             XrSenseDataProviderStateBD* state);

XRAPI_ATTR XrResult XRAPI_CALL xrQuerySenseDataAsyncBD(XrSenseDataProviderBD provider,
                                                       const XrSenseDataQueryInfoBD* queryInfo, XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrQuerySenseDataCompleteBD(XrSenseDataProviderBD provider, XrFutureEXT future,
                                                          XrSenseDataQueryCompletionBD* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroySenseDataSnapshotBD(XrSenseDataSnapshotBD snapshot);

XRAPI_ATTR XrResult XRAPI_CALL xrGetQueriedSenseDataBD(XrSenseDataSnapshotBD snapshot,
                                                       XrQueriedSenseDataGetInfoBD* getInfo,
                                                       XrQueriedSenseDataBD* queriedSenseData);
...
XRAPI_ATTR XrResult XRAPI_CALL xrCreateAnchorSpaceBD(XrSession session, const XrAnchorSpaceCreateInfoBD* createInfo,
                                                     XrSpace* space);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialAnchorAsyncBD)(XrSenseDataProviderBD provider,
                                                              const XrSpatialAnchorCreateInfoBD* info,
                                                              XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialAnchorCompleteBD)(XrSenseDataProviderBD provider, XrFutureEXT future,
                                                                 XrSpatialAnchorCreateCompletionBD* completion);
typedef XrResult(XRAPI_PTR* PFN_xrPersistSpatialAnchorAsyncBD)(XrSenseDataProviderBD provider,
                                                               const XrSpatialAnchorPersistInfoBD* info,
                                                               XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrPersistSpatialAnchorCompleteBD)(XrSenseDataProviderBD provider, XrFutureEXT future,
                                                                  XrFutureCompletionEXT* completion);
typedef XrResult(XRAPI_PTR* PFN_xrUnpersistSpatialAnchorAsyncBD)(XrSenseDataProviderBD provider,
                                                                 const XrSpatialAnchorUnpersistInfoBD* info,
                                                                 XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrUnpersistSpatialAnchorCompleteBD)(XrSenseDataProviderBD provider, XrFutureEXT future,
                                                                    XrFutureCompletionEXT* completion);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpatialAnchorAsyncBD(XrSenseDataProviderBD provider,
                                                            const XrSpatialAnchorCreateInfoBD* info,
                                                            XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpatialAnchorCompleteBD(XrSenseDataProviderBD provider, XrFutureEXT future,
                                                               XrSpatialAnchorCreateCompletionBD* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrPersistSpatialAnchorAsyncBD(XrSenseDataProviderBD provider,
                                                             const XrSpatialAnchorPersistInfoBD* info,
                                                             XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrPersistSpatialAnchorCompleteBD(XrSenseDataProviderBD provider, XrFutureEXT future,
                                                                XrFutureCompletionEXT* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrUnpersistSpatialAnchorAsyncBD(XrSenseDataProviderBD provider,
                                                               const XrSpatialAnchorUnpersistInfoBD* info,
                                                               XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrUnpersistSpatialAnchorCompleteBD(XrSenseDataProviderBD provider, XrFutureEXT future,
                                                                  XrFutureCompletionEXT* completion);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
typedef XrResult(XRAPI_PTR* PFN_xrShareSpatialAnchorAsyncBD)(XrSenseDataProviderBD provider,
                                                             ...
                                                             XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrShareSpatialAnchorCompleteBD)(XrSenseDataProviderBD provider, XrFutureEXT future,
                                                                XrFutureCompletionEXT* completion);
typedef XrResult(XRAPI_PTR* PFN_xrDownloadSharedSpatialAnchorAsyncBD)(XrSenseDataProviderBD provider,
                                                                      ...
                                                                      XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrDownloadSharedSpatialAnchorCompleteBD)(XrSenseDataProviderBD provider,
                                                                         XrFutureEXT future,
                                                                         XrFutureCompletionEXT* completion);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrShareSpatialAnchorAsyncBD(XrSenseDataProviderBD provider,
                                                           const XrSpatialAnchorShareInfoBD* info, XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrShareSpatialAnchorCompleteBD(XrSenseDataProviderBD provider, XrFutureEXT future,
                                                              XrFutureCompletionEXT* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrDownloadSharedSpatialAnchorAsyncBD(XrSenseDataProviderBD provider,
                                                                    const XrSharedSpatialAnchorDownloadInfoBD* info,
                                                                    XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrDownloadSharedSpatialAnchorCompleteBD(XrSenseDataProviderBD provider,
                                                                       XrFutureEXT future,
                                                                       XrFutureCompletionEXT* completion);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
typedef XrResult(XRAPI_PTR* PFN_xrCaptureSceneAsyncBD)(XrSenseDataProviderBD provider, const XrSceneCaptureInfoBD* info,
                                                       XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrCaptureSceneCompleteBD)(XrSenseDataProviderBD provider, XrFutureEXT future,
                                                          XrFutureCompletionEXT* completion);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrCaptureSceneAsyncBD(XrSenseDataProviderBD provider, const XrSceneCaptureInfoBD* info,
                                                     XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrCaptureSceneCompleteBD(XrSenseDataProviderBD provider, XrFutureEXT future,
                                                        XrFutureCompletionEXT* completion);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
typedef XrResult(XRAPI_PTR* PFN_xrResumeSimultaneousHandsAndControllersTrackingMETA)(
    XrSession session, const XrSimultaneousHandsAndControllersTrackingResumeInfoMETA* resumeInfo);
typedef XrResult(XRAPI_PTR* PFN_xrPauseSimultaneousHandsAndControllersTrackingMETA)(
...
// XrSpatialFilterTrackingStateEXT extends
// XrSpatialDiscoverySnapshotCreateInfoEXT,XrSpatialComponentDataQueryConditionEXT
...
typedef XrResult(XRAPI_PTR* PFN_xrEnumerateSpatialCapabilitiesEXT)(XrInstance instance, XrSystemId systemId,
                                                                   uint32_t capabilityCapacityInput,
                                                                   uint32_t* capabilityCountOutput,
                                                                   XrSpatialCapabilityEXT* capabilities);
typedef XrResult(XRAPI_PTR* PFN_xrEnumerateSpatialCapabilityComponentTypesEXT)(
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialContextAsyncEXT)(XrSession session,
                                                                const XrSpatialContextCreateInfoEXT* createInfo,
                                                                XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialContextCompleteEXT)(XrSession session, XrFutureEXT future,
                                                                   XrCreateSpatialContextCompletionEXT* completion);
typedef XrResult(XRAPI_PTR* PFN_xrDestroySpatialContextEXT)(XrSpatialContextEXT spatialContext);
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialDiscoverySnapshotAsyncEXT)(
    XrSpatialContextEXT spatialContext, const XrSpatialDiscoverySnapshotCreateInfoEXT* createInfo, XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialDiscoverySnapshotCompleteEXT)(
    XrSpatialContextEXT spatialContext,
    const XrCreateSpatialDiscoverySnapshotCompletionInfoEXT* createSnapshotCompletionInfo,
    XrCreateSpatialDiscoverySnapshotCompletionEXT* completion);
typedef XrResult(XRAPI_PTR* PFN_xrQuerySpatialComponentDataEXT)(
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialEntityFromIdEXT)(XrSpatialContextEXT spatialContext,
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialUpdateSnapshotEXT)(
    XrSpatialContextEXT spatialContext, const XrSpatialUpdateSnapshotCreateInfoEXT* createInfo,
    XrSpatialSnapshotEXT* snapshot);
typedef XrResult(XRAPI_PTR* PFN_xrGetSpatialBufferStringEXT)(XrSpatialSnapshotEXT snapshot,
                                                             const XrSpatialBufferGetInfoEXT* info,
                                                             uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                             char* buffer);
typedef XrResult(XRAPI_PTR* PFN_xrGetSpatialBufferUint8EXT)(XrSpatialSnapshotEXT snapshot,
                                                            const XrSpatialBufferGetInfoEXT* info,
                                                            uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                            uint8_t* buffer);
typedef XrResult(XRAPI_PTR* PFN_xrGetSpatialBufferUint16EXT)(XrSpatialSnapshotEXT snapshot,
                                                             const XrSpatialBufferGetInfoEXT* info,
                                                             uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                             uint16_t* buffer);
typedef XrResult(XRAPI_PTR* PFN_xrGetSpatialBufferUint32EXT)(XrSpatialSnapshotEXT snapshot,
                                                             const XrSpatialBufferGetInfoEXT* info,
                                                             uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                             uint32_t* buffer);
typedef XrResult(XRAPI_PTR* PFN_xrGetSpatialBufferFloatEXT)(XrSpatialSnapshotEXT snapshot,
                                                            const XrSpatialBufferGetInfoEXT* info,
                                                            uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                            float* buffer);
typedef XrResult(XRAPI_PTR* PFN_xrGetSpatialBufferVector2fEXT)(XrSpatialSnapshotEXT snapshot,
                                                               const XrSpatialBufferGetInfoEXT* info,
                                                               uint32_t bufferCapacityInput,
                                                               uint32_t* bufferCountOutput, XrVector2f* buffer);
typedef XrResult(XRAPI_PTR* PFN_xrGetSpatialBufferVector3fEXT)(XrSpatialSnapshotEXT snapshot,
                                                               const XrSpatialBufferGetInfoEXT* info,
                                                               uint32_t bufferCapacityInput,
                                                               uint32_t* bufferCountOutput, XrVector3f* buffer);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrEnumerateSpatialCapabilitiesEXT(XrInstance instance, XrSystemId systemId,
                                                                 uint32_t capabilityCapacityInput,
                                                                 uint32_t* capabilityCountOutput,
                                                                 XrSpatialCapabilityEXT* capabilities);
...
XRAPI_ATTR XrResult XRAPI_CALL
xrEnumerateSpatialCapabilityFeaturesEXT(XrInstance instance, XrSystemId systemId, XrSpatialCapabilityEXT capability,
                                        uint32_t capabilityFeatureCapacityInput, uint32_t* capabilityFeatureCountOutput,
                                        XrSpatialCapabilityFeatureEXT* capabilityFeatures);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpatialContextAsyncEXT(XrSession session,
                                                              const XrSpatialContextCreateInfoEXT* createInfo,
                                                              XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpatialContextCompleteEXT(XrSession session, XrFutureEXT future,
                                                                 XrCreateSpatialContextCompletionEXT* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroySpatialContextEXT(XrSpatialContextEXT spatialContext);
...
XRAPI_ATTR XrResult XRAPI_CALL xrDestroySpatialSnapshotEXT(XrSpatialSnapshotEXT snapshot);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpatialEntityFromIdEXT(XrSpatialContextEXT spatialContext,
                                                              const XrSpatialEntityFromIdCreateInfoEXT* createInfo,
                                                              XrSpatialEntityEXT* spatialEntity);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroySpatialEntityEXT(XrSpatialEntityEXT spatialEntity);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpatialUpdateSnapshotEXT(XrSpatialContextEXT spatialContext,
                                                                const XrSpatialUpdateSnapshotCreateInfoEXT* createInfo,
                                                                XrSpatialSnapshotEXT* snapshot);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSpatialBufferStringEXT(XrSpatialSnapshotEXT snapshot,
                                                           const XrSpatialBufferGetInfoEXT* info,
                                                           uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                           char* buffer);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSpatialBufferUint8EXT(XrSpatialSnapshotEXT snapshot,
                                                          const XrSpatialBufferGetInfoEXT* info,
                                                          uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                          uint8_t* buffer);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSpatialBufferUint16EXT(XrSpatialSnapshotEXT snapshot,
                                                           const XrSpatialBufferGetInfoEXT* info,
                                                           uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                           uint16_t* buffer);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSpatialBufferUint32EXT(XrSpatialSnapshotEXT snapshot,
                                                           const XrSpatialBufferGetInfoEXT* info,
                                                           uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                           uint32_t* buffer);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSpatialBufferFloatEXT(XrSpatialSnapshotEXT snapshot,
                                                          const XrSpatialBufferGetInfoEXT* info,
                                                          uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                          float* buffer);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSpatialBufferVector2fEXT(XrSpatialSnapshotEXT snapshot,
                                                             const XrSpatialBufferGetInfoEXT* info,
                                                             uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                             XrVector2f* buffer);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSpatialBufferVector3fEXT(XrSpatialSnapshotEXT snapshot,
                                                             const XrSpatialBufferGetInfoEXT* info,
                                                             uint32_t bufferCapacityInput, uint32_t* bufferCountOutput,
                                                             XrVector3f* buffer);
#endif /* XR_EXTENSION_PROTOTYPES */
...
// XrSpatialMarkerSizeEXT extends
// XrSpatialCapabilityConfigurationArucoMarkerEXT,XrSpatialCapabilityConfigurationAprilTagEXT,XrSpatialCapabilityConfigurationQrCodeEXT,XrSpatialCapabilityConfigurationMicroQrCodeEXT
...
// XrSpatialMarkerStaticOptimizationEXT extends
// XrSpatialCapabilityConfigurationArucoMarkerEXT,XrSpatialCapabilityConfigurationAprilTagEXT,XrSpatialCapabilityConfigurationQrCodeEXT,XrSpatialCapabilityConfigurationMicroQrCodeEXT
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialAnchorEXT)(XrSpatialContextEXT spatialContext,
...
#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpatialAnchorEXT(XrSpatialContextEXT spatialContext,
                                                        const XrSpatialAnchorCreateInfoEXT* createInfo,
                                                        XrSpatialEntityIdEXT* anchorEntityId,
                                                        XrSpatialEntityEXT* anchorEntity);
#endif /* XR_EXTENSION_PROTOTYPES */
...
// XrSpatialDiscoveryPersistenceUuidFilterEXT extends
// XrSpatialDiscoverySnapshotCreateInfoEXT,XrSpatialComponentDataQueryConditionEXT
...
typedef XrResult(XRAPI_PTR* PFN_xrEnumerateSpatialPersistenceScopesEXT)(
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialPersistenceContextAsyncEXT)(
    XrSession session, const XrSpatialPersistenceContextCreateInfoEXT* createInfo, XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialPersistenceContextCompleteEXT)(
    XrSession session, XrFutureEXT future, XrCreateSpatialPersistenceContextCompletionEXT* completion);
typedef XrResult(XRAPI_PTR* PFN_xrDestroySpatialPersistenceContextEXT)(
    XrSpatialPersistenceContextEXT persistenceContext);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrEnumerateSpatialPersistenceScopesEXT(XrInstance instance, XrSystemId systemId,
...
XRAPI_ATTR XrResult XRAPI_CALL xrDestroySpatialPersistenceContextEXT(XrSpatialPersistenceContextEXT persistenceContext);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
typedef XrResult(XRAPI_PTR* PFN_xrPersistSpatialEntityAsyncEXT)(XrSpatialPersistenceContextEXT persistenceContext,
                                                                const XrSpatialEntityPersistInfoEXT* persistInfo,
                                                                XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrPersistSpatialEntityCompleteEXT)(XrSpatialPersistenceContextEXT persistenceContext,
                                                                   XrFutureEXT future,
                                                                   XrPersistSpatialEntityCompletionEXT* completion);
typedef XrResult(XRAPI_PTR* PFN_xrUnpersistSpatialEntityAsyncEXT)(XrSpatialPersistenceContextEXT persistenceContext,
                                                                  const XrSpatialEntityUnpersistInfoEXT* unpersistInfo,
                                                                  XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrUnpersistSpatialEntityCompleteEXT)(XrSpatialPersistenceContextEXT persistenceContext,
                                                                     XrFutureEXT future,
                                                                     XrUnpersistSpatialEntityCompletionEXT* completion);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrPersistSpatialEntityAsyncEXT(XrSpatialPersistenceContextEXT persistenceContext,
                                                              const XrSpatialEntityPersistInfoEXT* persistInfo,
                                                              XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrPersistSpatialEntityCompleteEXT(XrSpatialPersistenceContextEXT persistenceContext,
                                                                 XrFutureEXT future,
                                                                 XrPersistSpatialEntityCompletionEXT* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrUnpersistSpatialEntityAsyncEXT(XrSpatialPersistenceContextEXT persistenceContext,
                                                                const XrSpatialEntityUnpersistInfoEXT* unpersistInfo,
                                                                XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrUnpersistSpatialEntityCompleteEXT(XrSpatialPersistenceContextEXT persistenceContext,
                                                                   XrFutureEXT future,
                                                                   XrUnpersistSpatialEntityCompletionEXT* completion);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
typedef XrResult(XRAPI_PTR* PFN_xrEnumerateSpatialEntityComponentTypesPICO)(
    XrSenseDataSnapshotPICO snapshot, XrSpatialEntityIdPICO entity, uint32_t componentTypeCapacityInput,
    uint32_t* componentTypeCountOutput, XrSpatialEntityComponentTypePICO* componentTypes);
typedef XrResult(XRAPI_PTR* PFN_xrGetSpatialEntityUuidPICO)(XrSenseDataSnapshotPICO snapshot,
                                                            XrSpatialEntityIdPICO entity, XrUuidEXT* uuid);
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSenseDataProviderPICO)(XrSession session,
                                                               XrSenseDataProviderCreateInfoBaseHeaderPICO* createInfo,
                                                               XrSenseDataProviderPICO* provider);
typedef XrResult(XRAPI_PTR* PFN_xrStartSenseDataProviderAsyncPICO)(XrSession session,
...
typedef XrResult(XRAPI_PTR* PFN_xrGetSenseDataProviderStatePICO)(XrSenseDataProviderPICO provider,
...
typedef XrResult(XRAPI_PTR* PFN_xrQuerySenseDataAsyncPICO)(XrSenseDataProviderPICO provider,
                                                           XrSenseDataQueryInfoPICO* queryInfo, XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrQuerySenseDataCompletePICO)(XrSenseDataProviderPICO provider, XrFutureEXT future,
...
typedef XrResult(XRAPI_PTR* PFN_xrGetQueriedSenseDataPICO)(XrSenseDataProviderPICO provider,
...
typedef XrResult(XRAPI_PTR* PFN_xrRetrieveSpatialEntityAnchorPICO)(XrSenseDataSnapshotPICO snapshot,
...
typedef XrResult(XRAPI_PTR* PFN_xrLocateAnchorPICO)(XrAnchorPICO anchor, XrAnchorLocateInfoPICO* locateInfo,
                                                    XrSpaceLocation* location);
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetSpatialEntityUuidPICO(XrSenseDataSnapshotPICO snapshot,
                                                          XrSpatialEntityIdPICO entity, XrUuidEXT* uuid);
...
XRAPI_ATTR XrResult XRAPI_CALL xrCreateSenseDataProviderPICO(XrSession session,
                                                             XrSenseDataProviderCreateInfoBaseHeaderPICO* createInfo,
                                                             XrSenseDataProviderPICO* provider);

XRAPI_ATTR XrResult XRAPI_CALL xrStartSenseDataProviderAsyncPICO(XrSession session,
                                                                 XrSenseDataProviderStartInfoPICO* startInfo,
                                                                 XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrStartSenseDataProviderCompletePICO(XrSession session, XrFutureEXT future,
...
XRAPI_ATTR XrResult XRAPI_CALL xrQuerySenseDataCompletePICO(XrSenseDataProviderPICO provider, XrFutureEXT future,
                                                            XrSenseDataQueryCompletionPICO* completion);
...
XRAPI_ATTR XrResult XRAPI_CALL xrRetrieveSpatialEntityAnchorPICO(XrSenseDataSnapshotPICO snapshot,
                                                                 XrSpatialEntityAnchorRetrieveInfoPICO* retrieveInfo,
                                                                 XrAnchorPICO* anchor);
...
XRAPI_ATTR XrResult XRAPI_CALL xrLocateAnchorPICO(XrAnchorPICO anchor, XrAnchorLocateInfoPICO* locateInfo,
                                                  XrSpaceLocation* location);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialAnchorAsyncPICO)(XrSenseDataProviderPICO provider,
                                                                XrSpatialAnchorCreateInfoPICO* info,
                                                                XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialAnchorCompletePICO)(XrSenseDataProviderPICO provider, XrFutureEXT future,
                                                                   XrSpatialAnchorCreateCompletionPICO* completion);
typedef XrResult(XRAPI_PTR* PFN_xrPersistSpatialAnchorAsyncPICO)(XrSenseDataProviderPICO provider,
                                                                 XrSpatialAnchorPersistInfoPICO* info,
                                                                 XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrPersistSpatialAnchorCompletePICO)(XrSenseDataProviderPICO provider,
                                                                    XrFutureEXT future,
                                                                    XrSpatialAnchorPersistCompletionPICO* completion);
typedef XrResult(XRAPI_PTR* PFN_xrUnpersistSpatialAnchorAsyncPICO)(XrSenseDataProviderPICO provider,
                                                                   XrSpatialAnchorUnpersistInfoPICO* info,
                                                                   XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrUnpersistSpatialAnchorCompletePICO)(
    XrSenseDataProviderPICO provider, XrFutureEXT future, XrSpatialAnchorUnpersistCompletionPICO* completion);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpatialAnchorAsyncPICO(XrSenseDataProviderPICO provider,
                                                              XrSpatialAnchorCreateInfoPICO* info, XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpatialAnchorCompletePICO(XrSenseDataProviderPICO provider, XrFutureEXT future,
                                                                 XrSpatialAnchorCreateCompletionPICO* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrPersistSpatialAnchorAsyncPICO(XrSenseDataProviderPICO provider,
                                                               XrSpatialAnchorPersistInfoPICO* info,
                                                               XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrPersistSpatialAnchorCompletePICO(XrSenseDataProviderPICO provider, XrFutureEXT future,
                                                                  XrSpatialAnchorPersistCompletionPICO* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrUnpersistSpatialAnchorAsyncPICO(XrSenseDataProviderPICO provider,
                                                                 XrSpatialAnchorUnpersistInfoPICO* info,
                                                                 XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrUnpersistSpatialAnchorCompletePICO(XrSenseDataProviderPICO provider,
                                                                    XrFutureEXT future,
...
typedef XrResult(XRAPI_PTR* PFN_xrShareSpatialAnchorAsyncPICO)(XrSenseDataProviderPICO provider,
                                                               XrSpatialAnchorShareInfoPICO* info, XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrShareSpatialAnchorCompletePICO)(XrSenseDataProviderPICO provider, XrFutureEXT future,
                                                                  XrSpatialAnchorShareCompletionPICO* completion);
typedef XrResult(XRAPI_PTR* PFN_xrDownloadSharedSpatialAnchorAsyncPICO)(XrSenseDataProviderPICO provider,
                                                                        XrSharedSpatialAnchorDownloadInfoPICO* info,
                                                                        XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrDownloadSharedSpatialAnchorCompletePICO)(
    XrSenseDataProviderPICO provider, XrFutureEXT future, XrSharedSpatialAnchorDownloadCompletionPICO* completion);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrShareSpatialAnchorAsyncPICO(XrSenseDataProviderPICO provider,
                                                             XrSpatialAnchorShareInfoPICO* info, XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrShareSpatialAnchorCompletePICO(XrSenseDataProviderPICO provider, XrFutureEXT future,
                                                                XrSpatialAnchorShareCompletionPICO* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrDownloadSharedSpatialAnchorAsyncPICO(XrSenseDataProviderPICO provider,
                                                                      XrSharedSpatialAnchorDownloadInfoPICO* info,
                                                                      XrFutureEXT* future);
...
typedef XrResult(XRAPI_PTR* PFN_xrStartSceneCaptureAsyncPICO)(XrSenseDataProviderPICO provider,
                                                              XrSceneCaptureStartInfoPICO* info, XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrStartSceneCaptureCompletePICO)(XrSenseDataProviderPICO provider, XrFutureEXT future,
                                                                 XrSceneCaptureStartCompletionPICO* completion);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrStartSceneCaptureAsyncPICO(XrSenseDataProviderPICO provider,
                                                            XrSceneCaptureStartInfoPICO* info, XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrStartSceneCaptureCompletePICO(XrSenseDataProviderPICO provider, XrFutureEXT future,
                                                               XrSceneCaptureStartCompletionPICO* completion);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
