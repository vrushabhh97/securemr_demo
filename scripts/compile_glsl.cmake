...
function(compile_glsl run_target_name)
    ...
    foreach(in_file IN LISTS ARGN)
        get_filename_component(glsl_dir "${in_file}" DIRECTORY)
        get_filename_component(glsl_stage "${in_file}" NAME_WE)
        set(out_file "${glsl_dir}/${glsl_stage}.spv")
        if(GLSL_COMPILER)
            # Run glslc if we can find it
            message(STATUS "Compile *.glsl using glslc")
            add_custom_command(
                OUTPUT "${out_file}"
                COMMAND
        ...
        elseif(GLSLANG_VALIDATOR)
            ...
            message(STATUS "Compile *.glsl using glslangValidator")
            add_custom_command(
                OUTPUT "${out_file}"
                COMMAND
            ...
            message(STATUS "Use precompiled *.spv")
